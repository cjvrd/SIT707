...
public class SeleniumOperations {
	...
	public static void open_chrome_loadpage_resize_close() {
		...
		System.out.println("Hello from <s215100352>, <Christian Virdo>");
		...
		// create dimension object to pass into set size function
		Dimension windowSize = new Dimension(640, 480);
		Dimension doubledWindowSize = new Dimension(1280, 960);
		 ...
		 */
		// set window size to doubledWindowSize
		driver.manage().window().setSize(doubledWindowSize);
